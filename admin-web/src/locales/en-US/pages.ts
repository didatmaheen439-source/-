export default {
  'pages.layouts.userLayout.title': 'Internal operations admin MVP baseline',
  ...
  'pages.login.password.placeholder': 'Password: 123456789',
  ...
  'pages.welcome.celebrationTitle':
    'Welcome to Guoji Dazi Operations Admin {v6}',
