export default {
  'pages.layouts.userLayout.title': '内部运营后台 MVP 基座验证版',
  'pages.login.accountLogin.tab': '账户密码登录',
  'pages.login.accountLogin.errorMessage': '账号或密码错误',
  'pages.login.failure': '登录失败，请重试！',
  'pages.login.success': '登录成功！',
  'pages.login.username.placeholder': '用户名：super_admin 等测试账号',
  'pages.login.username.required': '用户名是必填项！',
  'pages.login.password.placeholder': '密码: 123456789',
  ...
  'pages.welcome.celebrationTitle': '欢迎使用过级搭子运营管理后台 {v6}',
